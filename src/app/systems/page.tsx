    ...
    <>
        ...
        <Reveal>
          <section className="relative px-4 sm:px-6 py-20 sm:py-32 system-performance-section">
            ...
            <div className="max-w-[1200px] mx-auto relative z-10">
              ...
              <div className="performance-metrics-grid grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
              ...
              <div className="pricing-cards-grid grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
                ...
                <PremiumCard glow hover delay={0}>
                  <div className="flex flex-col h-full">
                    ...
                    <h3 className="text-xl font-black uppercase mb-2 text-teal">Starter System</h3>
                    <p className="text-sm text-gray-400 mb-6">For early-stage businesses</p>
                    <div className="mb-8">
                    ...
                    <div className="space-y-3 mb-8 flex-grow">
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <span className="text-sm text-gray-300">Basic automation</span>
                      </div>
                      <div className="flex items-start gap-3">
                        <svg className="w-5 h-5 text-teal flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                          <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                ...
                <PremiumCard glow hover delay={0.1}>
                  <div className="flex flex-col h-full">
                    <div className="flex items-center justify-between mb-6">
                      ...
                      <span className="text-xs font-bold uppercase tracking-wider px-3 py-1 bg-teal/10 text-teal rounded-full border border-teal/20">Popular</span>
                    </div>
                    <h3 className="text-xl font-black uppercase mb-2 text-teal">Growth System</h3>
                    <p className="text-sm text-gray-400 mb-6">For growing businesses</p>
                    <div className="mb-8">
                      <div className="text-4xl font-black text-white mb-2">
                        $899<span className="text-base font-normal text-gray-500">/month</span>
                      </div>
                    </div>
                    <div className="space-y-3 mb-8 flex-grow">
                      <div className="flex items-start gap-3">
                        ...
                        <span className="text-sm text-gray-300">Full website + funnel</span>
                      </div>
                      <div className="flex items-start gap-3">
                        <svg className="w-5 h-5 text-teal flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                          <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                        </svg>
                        <span className="text-sm text-gray-300">Advanced automation</span>
                      </div>
                      <div className="flex items-start gap-3">
                        <svg className="w-5 h-5 text-teal flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                          <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                ...
                <PremiumCard glow hover delay={0.2}>
                  <div className="flex flex-col h-full">
                    ...
                    <h3 className="text-xl font-black uppercase mb-2 text-teal">Scale System</h3>
                    <p className="text-sm text-gray-400 mb-6">For scaling companies</p>
                    <div className="mb-8">
                      <div className="text-4xl font-black text-white mb-2">
                        $1,299<span className="text-base font-normal text-gray-500">/month</span>
                      </div>
                    </div>
                    <div className="space-y-3 mb-8 flex-grow">
                      <div className="flex items-start gap-3">
                ...
                <PremiumCard glow hover delay={0.3}>
                  <div className="flex flex-col h-full">
                    ...
                    <h3 className="text-xl font-black uppercase mb-2 text-teal">Custom System</h3>
                    <p className="text-sm text-gray-400 mb-6">For unique requirements</p>
                    <div className="mb-8">
                      <div className="text-4xl font-black text-white mb-2">
                        Custom<span className="text-base font-normal text-gray-500 block">Pricing</span>
                      </div>
                    </div>
                    <div className="space-y-3 mb-8 flex-grow">
                      <div className="flex items-start gap-3">
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <span className="text-sm text-gray-300">Custom architecture</span>
                      </div>
                      <div className="flex items-start gap-3">
                        <svg className="w-5 h-5 text-teal flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                          <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
            ...
            <div className="max-w-[1200px] mx-auto relative z-10">
              ...
              <div className="services-grid grid grid-cols-2 lg:grid-cols-3 gap-6">
                <PremiumCard glow hover delay={0}>
                  ...
                  <p className="text-sm text-gray-300">Every system begins with strategic planning.</p>
                </PremiumCard>
                ...
                <PremiumCard glow hover delay={0.1}>
                  ...
                  <p className="text-sm text-gray-300">Websites, funnels, automation built to work together.</p>
                </PremiumCard>
                ...
                <PremiumCard glow hover delay={0.2}>
                  ...
                  <p className="text-sm text-gray-300">Performance monitoring powered by AI.</p>
                </PremiumCard>
                ...
                <PremiumCard glow hover delay={0.3}>
                  ...
                  <p className="text-sm text-gray-300">Continuous improvement based on data.</p>
                </PremiumCard>
                ...
                <PremiumCard glow hover delay={0.4}>
                  ...
                  <p className="text-sm text-gray-300">Direct access to strategic advisors.</p>
                </PremiumCard>
                ...
                <PremiumCard glow hover delay={0.5}>
                  ...
                  <p className="text-sm text-gray-300">Infrastructure designed to grow with you.</p>
                </PremiumCard>
              </div>
            </div>
          </section>
      ...
      <style jsx global>{`
        @media (min-width: 1024px) {
          /* Fix System Performance metrics - fill width, reduce gap */
          ...
          /* Fix Pricing cards - evenly spaced full width */
          .pricing-cards-grid {
            grid-template-columns: repeat(4, 1fr);
            gap: 1.5rem;
          }
